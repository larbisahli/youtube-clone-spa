...
import styles from "./sass/hv.module.scss";
  ...
  return (
    <div className={styles.hvcontainer}>
      <div className={styles.wrapper}>
        <div className={GetClassName(styles, "thumbnail_container", Theme)}>
        ...
        <div className={styles.body_container}>
          ...
          <div className={styles.text_area}>
            <div
              onClick={HandleLink}
              className={GetClassName(styles, "titlewrap", Theme)}
            >
              <div
            ...
            <Link
              ...
              className={GetClassName(styles, "ch_titlewrap", Theme)}
              to={`/channel/${PopularVideo.channelId}`}
            >
              {PopularVideo.channelTitle}
            </Link>
          ...
          <div className={GetClassName(styles, "dots", Theme)}>
            <DotsSvg />
          </div>
        </div>
      </div>
